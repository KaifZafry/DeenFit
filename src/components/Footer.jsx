                ...
                <div  className="container">
                    <div  className="footer-top-wrap">
                        ...
                        <ul  className="tf-social-icon style-large">
                            ...
                            <li>
                                <a href="https://www.snapchat.com/"  className="social-item social-linkedin"><i
                                         className="icon icon-linkedin"></i></a>
                            </li>
                            <li>
                                ...
                                <div  className="footer-contact">
                                    <ul  className="footer-info">
                                        ...
                                        <li  className="item">
                                            ...
                                            <a href="tel:18888383022"  className="">(64) 8342 1245</a>
                                        </li>
                                        <li  className="item">
                                            <span  className="box-icon">
                                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                            ...
                                            <a href="mailto:support@example.com"  className="">support@example.com</a>
                                        </li>
                                    </ul>
                                                        ...
                                                        <div  className="sib-input sib-form-block">
                                                            <div  className="form__entry entry_block">
                                                                <div  className="form__label-row ">
                                                                    <label  className="entry__label" for="EMAIL"></label>
                                                                    <fieldset  className="entry__field">
                                                                        <input  className="input radius-60" type="text"
                                                            ...
                                                            <div  className="form__entry entry_mcq">
                                                                <div  className="form__label-row ">
                                                                    <div  className="entry__choice">
                                                                        <label>
                                                                            <input type="checkbox"
                                                                                 className="input_replaced" value="1"
                                                                                id="OPT_IN" name="OPT_IN" />
                                                                            <span
                                                                                 className="checkbox checkbox_tick_positive"></span>
                                                                            <span>
                                                                                <p></p>
                                                                            </span>
                                                                        </label>
                        ...
                        <div  className="footer-inner-wrap s3">
                            <div  className="footer-col-block inner-col">
                                ...
                                <div  className="tf-collapse-content">
                                    <ul  className="footer-menu-list">
                                        <li>
                                            <a  className="" href="about-us.html">About Us</a>
                                        </li>
                                        <li>
                                            <a  className="" href="contact-us.html">Contact Us</a>
                                        </li>
                                        <li>
                                            <a  className="" href="store-location.html">Our Store</a>
                                        </li>
                                        <li>
                                            <a  className="" href="about-us.html">Our Story</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div  className="footer-col-block inner-col">
                                ...
                                <div  className="tf-collapse-content">
                                    <ul  className="footer-menu-list">
                                        <li>
                                            <a  className="" href="privacy-policy.html">Privacy Policies</a>
                                        </li>
                                        <li>
                                            <a  className="" href="term-and-condition.html">Terms & Conditions</a>
                                        </li>
                                        <li>
                                            <a  className="" href="return-and-refund.html">Returns & Refunds</a>
                                        </li>
                                        <li>
                                            <a  className="" href="faq.html">FAQ’s</a>
                                        </li>
                                        <li>
                                            <a  className="" href="shipping.html">Shipping</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div  className="footer-bottom">
                <div  className="container">
                    <div  className="footer-bottom-wrap">
                        <p  className="text-dark ">Copyright © 2025 by <span  className="fw-medium">Vineta.</span> All
                            Rights
                            Reserved.</p>
