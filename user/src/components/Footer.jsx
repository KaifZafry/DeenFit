                ...
                <div  className="container-full ">
                    <div  className="footer-top-wrap ">
                        <div  className="footer-logo">
                            <Link to='/' >
                                <img src="/deenfitlogo.png"  className="logo" alt="logo"/>
                            </Link>
                        </div>
                                    ...
                                    <ul  className="footer-info">
                                        <li  className="item">
                                            ...
                                            <a target="_blank"  className=""
                                                href="https://maps.app.goo.gl/Z9NnvFUcxw18faZz9">
                                               F-104/3, Shaheen Bagh, Okhla , New Delhi India (110025)
                                            </a>
                                        </li>
                                        <li  className="item">
                                            <span  className="box-icon">
                                            ...
                                            <a href="tel:9608240986"  className="">+91 9608240986</a>
                                        </li>
                                        <li  className="item">
                                            <span  className="box-icon">
                                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                                            ...
                                                            <div  className="form__entry entry_mcq">
                                                                <div  className="form__label-row ">
                                                                    <div  className="entry__choice">
                                                                        <label>
                                                                            <input type="checkbox"
                                                                                 className="input_replaced" readOnly value="1"
