...
const Sizechart = ({ isVisible, onClose }) => {
  return (
    <div
      className={`modal fade modalCentered modal-find-size justify-content-center ${isVisible ? 'show' : ''}`}
      style={{ zIndex: 1060, display: isVisible ? 'flex' : 'none' }}
    >
        ...
        <div className="modal-content">
          ...
          <div className="tf-rte">
            ...
            <div className="tf-page-size-chart-content">
              <div>
                <div className="title">Style Measurements:</div>
                <ul>
                  <li className="text">1. Chest</li>
                  <li className="text-main">Measure at the fullest part of your chest, keeping the tape parallel to the floor.</li>
                  <li className="text">2. Waist</li>
                  <li className="text-main">Measure at the smallest part of your waist.</li>
                  <li className="text">3. Hip</li>
                  <li className="text-main">Measure at the fullest part of your seat.</li>
                </ul>
              </div>
              <div className="text-md-end text-center">
                <img className="sizechart" src="/images/section/size-guide.png" alt=""/>
              </div>
            </div>
          </div>
        </div>
