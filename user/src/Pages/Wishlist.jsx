...
const WishlistPage = () => {
    ...
    return (
        <div className="container mx-auto p-4">
            <h1 data-aos="fade-up" data-aos-duration="600" className="text-lg md:text-xl font-bold mb-4">Your Wishlist</h1>
            ...
            {wishlistItems.length === 0 ? (
                <div className="flex flex-col items-center justify-center text-center py-12">
                    <img
                        ...
                        alt="Empty Wishlist"
                        className="w-48 h-48 mb-6 opacity-80" data-aos="fade-up" data-aos-duration="600"
                    />
                    <h2 className="text-xl font-semibold mb-2" data-aos="fade-up" data-aos-duration="600">Your wishlist is empty</h2>
                    <p className="text-gray-500" data-aos="fade-up" data-aos-duration="600">Start adding items you love!</p>
                    <Link
                        tp="/products"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {wishlistItems.map((item) => {
                        const mainImage= item.product_image[0];
